...
<body>
    ...
    <main>
                ...
                <form:form method="post" action="save_room" modelAttribute="roomEntity">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><form:input type="file" name="main-img" id="main-img" path="mainImage"/>
                        ...
                        <tr>
                            ...
                            <td><form:textarea name="description" id="description" cols="30" rows="10" path="description"/>
        ...
        <div class="right">
            ...
            <c:forEach var="typeRoomEntity" items="${listTypeRoomEntityList}">
                    <p>${typeRoomEntity.getTypeRoomName()}</p>
            </c:forEach>
        </div>
    </main>
