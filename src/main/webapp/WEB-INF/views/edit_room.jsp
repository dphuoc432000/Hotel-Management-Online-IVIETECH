    ...
    <main>
        <div class="left">
            <div class="form-container">
                <form:form method="post" action="save_edit_room" modelAttribute="roomEntity">
                    <table>
                        <tr style="display: none">
                            <td><form:label path="roomID">Room ID</form:label></td>
                            <td>
                                <form:input type="text" name="roomID" value="${roomEntity.getRoomID()}" id="roomID" path="roomID"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <form:input type="text" name="roomNumber" value="${roomEntity.getRoomNumber()}" id="roomNumber" path="roomNumber"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <form:input type="text" name="price" id="price" value="${roomEntity.getPrice()}" path="price"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <form:input type="number" name="size" value="${roomEntity.getSize()}" id="size" path="size"/>
                                <form:errors path="size" cssClass="error" />
                            </td>
                        </tr>
                        <tr>
                            <td><form:label path="mainImage">Main Image</form:label></td>
                            <td><form:input type="file" name="mainImage" id="mainImage" value="${roomEntity.getMainImage()}" accept="image/png, image/jpeg" path="mainImage"/>
                                <form:errors path="mainImage" cssClass="error" /></td>
                        </tr>
                        <tr>
                            <td><form:label path="subImage1">Sub Image</form:label></td>
                            <td><form:input type="file" name="sub-img"  value="${roomEntity.getSubImage1()}" id="sub-img" path="subImage1"/>
                                <form:errors path="subImage1" cssClass="error" />
                            </td>
                        </tr>
                        <tr>
                            <td><form:label path="subImage2">Sub Image</form:label></td>
                            <td><form:input type="file" name="sub-img" value="${roomEntity.getSubImage2()}" id="sub-img" path="subImage2"/>
                                <form:errors path="subImage2" cssClass="error" />
                            </td>
                        </tr>
                        <tr>
                            <td><form:label path="subImage3">Sub Image</form:label></td>
                            <td><form:input type="file" name="sub-img" value="${roomEntity.getSubImage3()}" id="sub-img" path="subImage3"/>
                                <form:errors path="subImage3" cssClass="error" />
                            </td>
                        </tr>
                        <tr>
                            <td><form:label path="description">Description</form:label></td>
                            <td><form:textarea name="description" id="description" value="${roomEntity.getDescription()}" cols="30" rows="0" cssStyle="resize: none" path="description"/>
...
<%--                        </tr>--%>
        ...
        <div class="right">
            ...
            <a href="<c:url value="/admin/room/setup_room"/>" class="return">Return a page</a>
        </div>
